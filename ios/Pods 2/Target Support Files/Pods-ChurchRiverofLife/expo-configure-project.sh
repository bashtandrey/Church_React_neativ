...
with_node \
  ...
  --target "/Users/bashtandrey/Documents/Program_Andrii/ChurchAPP/Church_React_neativ/ios/Pods/Target Support Files/Pods-ChurchRiverofLife/ExpoModulesProvider.swift" \
  --entitlement "/Users/bashtandrey/Documents/Program_Andrii/ChurchAPP/Church_React_neativ/ios/ChurchRiverofLife/ChurchRiverofLife.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-local-authentication" "expo-localization" "expo-notifications" "expo-secure-store" "expo-updates"
